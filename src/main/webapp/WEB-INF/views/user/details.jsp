...
<main>
                ...
                <div class="col">
                    <div class="banner-common__content">
                        ...
                        <div class="banner-common__box"><a href="./index.html">
                            ...
                            <div class="banner-common__icon"><img src="./img/arrows-banner.svg" alt=""/></div>
                            <a href="">
                                <p class="banner-common__title-2">Sản Phẩm</p></a>
                            <div class="banner-common__icon"><img src="./img/arrows-banner.svg" alt=""/></div>
                            <a href="">
                                <p class="banner-common__title-2 banner-common__title-2--active">Chi Tiết Sản Phẩm</p>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div class="details__info" data-aos="fade-left" data-aos-delay="0">
                        ...
                        <div class="details__rate">
                            <p>Đánh giá: <span><i class="fas fa-star"></i><i class="fas fa-star"></i><i
                                    class="fas fa-star"></i><i class="fas fa-star"></i><i
                                    class="fas fa-star"></i></span></p>
                        </div>
                        <div class="details__stocking"><i
                                class="fas fa-check"></i><span>Số Lượng còn: ${product.soLuongTon } </span></div>
                        ...
                        <div class="details__select">
                            <div class="details__number"><span class="details__number-minus"><i
                                    class="fas fa-minus"></i></span><span class="details__number-basket">1 </span><span
                                    class="details__number-plus">  <i class="fas fa-plus"></i></span></div>
                            <button class="details__add-to-basket custom2" onclick="addToCart(${product.id},1)">Thêm
                                vào giỏ</button>
                        </div>
                        <div class="details__share">
                            <div class="details__share-title">Chia sẻ sản phẩm:</div>
                            <a href="#"> <i class="fab fa-google-plus-square"></i></a><a href="#"> <i
                                class="fab fa-facebook-square"></i></a><a href="#"> <i
                                class="fab fa-twitter-square"></i></a><a href="#"> <i class="fab fa-youtube-square"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="popula">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="heading__primary heading__primary--bot" data-aos="fade-up" data-aos-delay="0">Sản Phẩm
                        Liên Quan</h2>
                    <div class="popula__carousel" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <c:forEach var="listpr" items="${listProduct}">
                            <div class="best-slice__card">
                                <div class="best-slice__photo"><a href="${base }/detail/${listpr.id}"><img
                                        src="${base }/upload/${listpr.avatar}" alt="Banh-Bông Lan"
                                        title="Bánh Bông Lan"/></a></div>
                                <div class="best-slice__content"><a href="${base }/detail/${listpr.id}">
                                    <h3 class="best-slice__heading"> ${listpr.title}</h3></a>
                                    <div class="best-slice__rate"><i class="fas fa-star"></i><i class="fas fa-star"></i><i
                                            class="fas fa-star"></i><i class="fas fa-star"></i><i
                                            class="fas fa-star"></i></div>
                                    <div class="best-slice__price">${listpr.price}</div>
                                    <a class="best-slice__button" href="./cart.html"><span>Thêm Vào Giỏ</span><i
