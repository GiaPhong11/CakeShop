					...
					<div class="col">
						<div class="banner-common__content">
							...
							<div class="banner-common__box">
								...
								<a href="">
									<p class="banner-common_title-2 banner-common_title-2--active">Liên Hệ</p>
								</a>
							</div>
						</div>
					</div>
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
						...
						<sf:form class="contact__sent" action="${base }/contact"
							...
							<button type="button" class="btn__sent" 
								...
								tin</button>
							<input class="btn__sent"  type="button" id="resetform" value="Reset" />
						...
						<div class="contact__infor">
							<div class="infor__group">
								...
								<div class="infor__group__content">
									...
									<p class="infor__text">150 ngõ Xã Đàn 2, Quận Đống Đa, TP.
										Hà Nội</p>
								</div>
							</div>
							<div class="infor__group">
								...
								<div class="infor__group__content">
									...
									<p class="infor__number">0987156321</p>
								</div>
							</div>
							<div class="infor__group">
