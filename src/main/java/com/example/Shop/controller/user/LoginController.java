...
public class LoginController extends BaseController {
    ...
    public String login(@Valid @ModelAttribute("user") UserEntity user, BindingResult result) throws IOException {
    ...
    public String saveContact(@Valid @ModelAttribute("regis") UserEntity regis, BindingResult result,
                              final Model model,
                              final HttpServletRequest request,
                              final HttpServletResponse response)
            throws IOException {
