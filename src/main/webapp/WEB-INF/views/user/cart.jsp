					...
					<div class="col">
						<div class="banner-common__content">
							...
							<div class="banner-common__box">
								...
								<a href="">
									<p class="banner-common__title-2 banner-common__title-2--active">Giỏ Hàng</p>
								</a>
							</div>
						</div>
					</div>
						...
						<div class="cart__list" data-aos="fade-up" data-aos-delay="100">
							<table>
								...
								<tr class="cart__row">
									...
									<td><button title="cancel" class="icon btn-delete" onclick="deleteProduct(${cartItem.productId})"><i class="far fa-trash-alt"></i></button></td>
									<td>
									...
									<td>
									${cartItem.priceUnit }</td>
									<td>
										<div class="cart__select">
											<i class="fas fa-minus"></i><span
												class="details__number-basket">${cartItem.quanlity } </span><i
												class="fas fa-plus"></i>
										</div>
									</td>
								...
								<div class="col-xl-4 col-lg-5 col-md-6 col-sm-9 col-12">
									<div class="money__content">
										...
										<div class="money__price">
											<p>
												${cartItem.productName } x<span>${cartItem.quanlity }</span>
											</p>
											<p>${cartItem.priceUnit }</p>
										</div>		
										</c:forEach>							
										<p class="money__car">
										...
										<a class="money__pay" href="${base }/cart/checkout">Tiến Hành
											Thanh Toán</a>
									</div>
								</div>
							</div>
