...
<div class="header__user1" style="padding: 0 400px;">
    <div class="user__box">
        <p class="user__action "><a style="color: black" href="${base }/login">Đăng nhập</a></p>
        <p class="user__action user--active"><a style="color: black" href="${base }/register">Đăng ký</a></p>
    </div>
    <sf:form class="user__form" method="POST"
             action="${base }/register" modelAttribute="regis">
        <div class="group-input">
            <input type="text" id="username" name="username"
                   placeholder="Họ và Tên"/>
            <span class="errors-red"><sf:errors path="username" ></sf:errors></span>
        </div>
        <div class="group-input">
            <input type="email" id="email" name="email" placeholder="Email"/>
            <span class="errors-red"><sf:errors path="email"></sf:errors></span>
        </div>
        <div class="group-input">
            <input type="password" id="password" name="password"
                   placeholder="Mật khẩu"/>
            <span class="errors-red"><sf:errors path="password"></sf:errors></span>
